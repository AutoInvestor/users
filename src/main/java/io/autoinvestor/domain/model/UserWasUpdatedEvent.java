...
public class UserWasUpdatedEvent extends Event<UserWasUpdatedEventPayload> {
    ...
    public static UserWasUpdatedEvent with(UserId userId, RiskLevel riskLevel) {
        UserWasUpdatedEventPayload payload = new UserWasUpdatedEventPayload(riskLevel.value());
        return new UserWasUpdatedEvent(userId, payload);
    }

    public static UserWasUpdatedEvent hydrate(
            EventId id,
            Id aggregateId,
            UserWasUpdatedEventPayload payload,
            Date occurredAt,
